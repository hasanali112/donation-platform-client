...
const AllStaticSeceond = () => {
  return (
    <div className="flex flex-col lg:flex-row">
      ...
      <div className="bg-black bg-opacity-30 text-white  lg:w-[258px] h-[258px]">
        <div className="flex flex-col mt-20">
      ...
      <div className="bg-gray-200 cursor-pointer hover:bg-slate-600 bg-opacity-35 text-white  lg:w-[258px] h-[258px]">
        <Link to="/package">
          <div className="flex flex-col mt-20">
